...
async def update_settings(
    ...
    Uses model_fields_set to detect which fields were actually sent in the
    request body — so PATCH {"alert_threshold": 10.0} won't touch email_enabled.
    ...
    if "search_queries" in body.model_fields_set:
        ...
        settings.search_queries = ",".join(cleaned)
